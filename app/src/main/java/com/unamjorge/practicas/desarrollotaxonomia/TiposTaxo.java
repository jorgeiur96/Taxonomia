...
public class TiposTaxo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tipos_taxo);
    ...
    public  void  adaptador(){
       ...
       TipoAdaptador taxoadaptador=new TipoAdaptador(atribu);
    ...
    public void obtDatos(){
        ...
        String url="https://serox.000webhostapp.com/Tipo.php";
    ...
    public ArrayList<String> obtDatos (String response){
        ...
        try {
            ...
            for (int i=0;i<21;i++){
                ...
                zonaa=jsonArray.getJSONObject(i).getString("Familia");

                obj.setZonas(zonaa);

                atribu.add(new atributosTaxonomia(obj.getZonas()));
